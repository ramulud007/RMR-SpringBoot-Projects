...
public class CategoryRestController {
	...
	@PostMapping(value = "/add-Category-ms")
	...
	@GetMapping(value = "/get-Category-By-Id-ms/{id}")
	...
	@GetMapping(value = "/get-All-Category-ms")
	...
	@DeleteMapping(value = "/delete-Category-By-Id-ms/{id}")
	...
	@PutMapping(value = "/update-Category-ms")
	...
	@GetMapping(value = "/sort-Category-ms")
	...
	@GetMapping(value = "/get-Max-Category-Gst-ms")
