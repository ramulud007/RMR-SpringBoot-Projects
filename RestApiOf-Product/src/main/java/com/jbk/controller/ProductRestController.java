...
public class ProductRestController {
	...
	@PostMapping(value = "/add-Product-ms")
	...
	@GetMapping(value = "/get-All-Products-ms")
	...
	@PutMapping(value = "/update-Product-ms")
	...
	@DeleteMapping(value = "/delete-Product-ms/{id}")
	...
	@GetMapping(value = "/get-Product-By-Id-ms/{productId}")
	...
	@GetMapping(value = "/sortBy-fieldName-ms")
	...
	@GetMapping(value = "/get-Product-maxPrice-ms")
	...
	@GetMapping(value="/count-SumOf-ProductPrice-ms")
	...
	@GetMapping(value = "/get-TotalCount-Of-Products-ms")
	...
	@GetMapping(value = "/get-productBy-Name-ms/{name}")
	...
	//Need to Check.
	@DeleteMapping(value="/delete-ProductBy-Name-ms/{name}")
	...
	@PostMapping(value = "/upload-File-ms")
	public ResponseEntity<String> uploadFile(@RequestBody MultipartFile file) {
		String msg = service.uploadFile(file);
		return ResponseEntity.ok(msg);
	}

	@GetMapping(value = "/getFinal-Product-ById-ms/{id}")
	public ResponseEntity<FinalProduct> getFinalProductById(@PathVariable("id") Long productId) {
		...
		if (finalProduct!= null) {
			...
			throw new ProductNotExistsException("Product Not Exist: "+productId);
		}
	}

	@GetMapping(value="/get-ProductById-With-CategorySupplier-ms/{productId}")
	public ResponseEntity<Product_Category_Supplier> getProductWithCategorySupplier(@PathVariable Long productId) {
		
		Product_Category_Supplier pcs = service.getProductWithCategorySupplier(productId);
		
		if (pcs != null) {
			return new ResponseEntity<Product_Category_Supplier>(pcs, HttpStatus.FOUND);
		}
		else{
			throw new ProductNotExistsException("Product Not Exists...");
		}
