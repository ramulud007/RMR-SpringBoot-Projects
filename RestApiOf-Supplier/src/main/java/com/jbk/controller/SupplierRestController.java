...
public class SupplierRestController {
	...
	@PostMapping(value = "/add-Suppliers-ms")
	...
	@GetMapping(value = "/get-Supplier-By-Id-ms/{id}")
	...
	@GetMapping(value = "/get-All-Suppliers-ms")
	...
	@DeleteMapping(value = "/delete-Supplier-By-Id-ms/{id}")
	...
	@PutMapping(value = "/update-Supplier-ms")
